 ...
 *
 * Текст из документа стенд достаёт и показывает во вкладке «Материалы», но
 * выводов из него не делает — это сказано на экране, а не спрятано в
  ...
  return (
    <form onSubmit={submit} className="mt-3 space-y-3 rounded-lg border border-line bg-surface p-3.5">
      <p className="text-[12px] leading-relaxed text-muted">
        Система <strong>не делает выводов</strong> из текста документа. Приложив
        файл, вы утверждаете, что он подтверждает факт; файл останется в деле
        как основание этого утверждения, а дело будет пересчитано. Прочитать сам
        текст можно во вкладке «Материалы».
      </p>
