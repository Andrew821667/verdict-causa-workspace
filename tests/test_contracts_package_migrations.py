...
def test_legacy_contracts_artifact_requires_replay_through_ordered_steps() -> None:
    ...
    assert report.target_package_version == "0.15.0"
...
def test_exported_legacy_migration_report_fixture_is_valid() -> None:
    fixture_path = Path("examples/migrations/contracts-ru-v0-0.1.0-to-0.15.0-migration-report.json")
...
def test_exported_0_3_migration_report_fixture_is_valid() -> None:
    fixture_path = Path("examples/migrations/contracts-ru-v0-0.3.0-to-0.15.0-migration-report.json")
...
def test_exported_0_4_migration_report_fixture_is_valid() -> None:
    fixture_path = Path("examples/migrations/contracts-ru-v0-0.4.0-to-0.15.0-migration-report.json")
    report = PackageMigrationReport.model_validate_json(fixture_path.read_text(encoding="utf-8"))
...
def test_exported_0_5_migration_report_fixture_is_valid() -> None:
    fixture_path = Path("examples/migrations/contracts-ru-v0-0.5.0-to-0.15.0-migration-report.json")
    report = PackageMigrationReport.model_validate_json(fixture_path.read_text(encoding="utf-8"))
...
def test_exported_0_6_migration_report_fixture_is_valid() -> None:
    fixture_path = Path("examples/migrations/contracts-ru-v0-0.6.0-to-0.15.0-migration-report.json")
    report = PackageMigrationReport.model_validate_json(fixture_path.read_text(encoding="utf-8"))
...
def test_exported_0_7_migration_report_fixture_is_valid() -> None:
    fixture_path = Path("examples/migrations/contracts-ru-v0-0.7.0-to-0.15.0-migration-report.json")
    report = PackageMigrationReport.model_validate_json(fixture_path.read_text(encoding="utf-8"))
...
def test_exported_0_8_migration_report_fixture_is_valid() -> None:
    fixture_path = Path("examples/migrations/contracts-ru-v0-0.8.0-to-0.15.0-migration-report.json")
    report = PackageMigrationReport.model_validate_json(fixture_path.read_text(encoding="utf-8"))
...
def test_0_14_trace_requires_performance_remedies_replay() -> None:
    ...
    assert report.disposition == MigrationDisposition.REQUIRES_REGENERATION
    assert [(step.from_version, step.to_version) for step in report.steps] == [("0.14.0", "0.15.0")]
