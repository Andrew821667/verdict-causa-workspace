...
MIGRATION_FIXTURES = (
    ...
    ("0.89.0", "contracts-ru-v0-0.89.0-phase0-trace.json", "контракт данных о сделке"),
    ("0.90.0", "contracts-ru-v0-0.90.0-phase0-trace.json", "об исчислении сроков"),
    ("0.91.0", "contracts-ru-v0-0.91.0-phase0-trace.json", "дееспособности"),
    ("0.92.0", "contracts-ru-v0-0.92.0-phase0-trace.json", "объекте гражданских прав"),
    ("0.93.0", "contracts-ru-v0-0.93.0-phase0-trace.json", "слой сверки фактов"),
    ("0.94.0", "contracts-ru-v0-0.94.0-phase0-trace.json", "смоделированных фабул"),
    ("0.95.0", "contracts-ru-v0-0.95.0-phase0-trace.json", "позициям Верховного Суда"),
    ("0.96.0", "contracts-ru-v0-0.96.0-phase0-trace.json", "сработать не могли"),
    ("0.97.0", "contracts-ru-v0-0.97.0-phase0-trace.json", "возложения ответственности"),
    ("0.98.0", "contracts-ru-v0-0.98.0-phase0-trace.json", "решений собраний"),
    ("0.99.0", "contracts-ru-v0-0.99.0-phase0-trace.json", "просрочке кредитора"),
    ("1.0.0", "contracts-ru-v0-1.0.0-phase0-trace.json", "прекращении обязательства"),
    ("1.1.0", "contracts-ru-v0-1.1.0-phase0-trace.json", "решениях собраний"),
    ("1.2.0", "contracts-ru-v0-1.2.0-phase0-trace.json", "впервые читает"),
    ("1.3.0", "contracts-ru-v0-1.3.0-phase0-trace.json", "юридически значимом сообщении"),
    ("1.4.0", "contracts-ru-v0-1.4.0-phase0-trace.json", "специальном виде банковского счёта"),
    ("1.5.0", "contracts-ru-v0-1.5.0-phase0-trace.json", "условном депонировании"),
    ("1.6.0", "contracts-ru-v0-1.6.0-phase0-trace.json", "статьи 431.1"),
    ...
    ("1.11.0", "contracts-ru-v0-1.11.0-phase0-trace.json", "вырос с 14 записей до 19"),
    ("1.12.0", "contracts-ru-v0-1.12.0-phase0-trace.json", "с 309 до 320 записей"),
    ("1.13.0", "contracts-ru-v0-1.13.0-phase0-trace.json", "bankruptcy_claims.py"),
    ("1.14.0", "contracts-ru-v0-1.14.0-phase0-trace.json", "bankruptcy_ranking.py"),
    ("1.15.0", "contracts-ru-v0-1.15.0-phase0-trace.json", "bankruptcy_contest.py"),
    ("1.16.0", "contracts-ru-v0-1.16.0-phase0-trace.json", "bankruptcy_setoff.py"),
    ("1.17.0", "contracts-ru-v0-1.17.0-phase0-trace.json", "подключены к reviewed_analysis.py"),
    ("1.18.0", "contracts-ru-v0-1.18.0-phase0-trace.json", "редакционный аппарат КонсультантПлюс"),
    ("1.19.0", "contracts-ru-v0-1.19.0-phase0-trace.json", "contract_asserted"),
    ("1.20.0", "contracts-ru-v0-1.20.0-phase0-trace.json", "очерёдности текущих платежей"),
)
...
def test_legacy_artifact_requires_ordered_replay(
    ...
    assert report.target_package_version == "1.21.0"
...
def test_exported_migration_report_is_valid(source_version: str, fixture_name: str) -> None:
    report_path = Path(
        f"examples/migrations/contracts-ru-v0-{source_version}-to-1.21.0-migration-report.json"
    )
