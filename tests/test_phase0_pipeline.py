...
def test_supply_dispute_pipeline_has_no_failed_steps() -> None:
    ...
    assert {step.id for step in result.steps} >= {
        ...
        "evaluate-contract-temporal-effect",
        "evaluate-limitation-period",
        "evaluate-contract-interpretation",
        "evaluate-transaction-form",
        ...
        "evaluate-framework-constructions",
        "evaluate-freedom-and-price",
        "evaluate-conclusion-procedure",
        ...
        "evaluate-commission",
        "evaluate-agency",
        "evaluate-trust-management",
        "evaluate-franchise",
        "evaluate-partnership",
        "evaluate-public-promise",
        "evaluate-games",
        "evaluate-tort-general",
        "evaluate-tort-life-health",
        ...
        "evaluate-general-sale-rules",
        "evaluate-special-supply-rules",
