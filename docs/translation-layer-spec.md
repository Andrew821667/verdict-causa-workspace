...
Текущий набор покрывает применимость источника, заключение и действительность сделки, обеспечение, динамику и исполнение обязательства, общие правила купли-продажи, специальные правила поставки, изменение и прекращение, ответственность, пропуск срока, средства защиты и необходимость экспертного решения.

## Версионирование шаблонов

`TranslationTemplateSet` содержит ровно один шаблон каждого уровня, локаль `ru-RU`, версию и SHA-256 hash канонического JSON. Версия `translation-template-ru-v11` добавляет профессиональное объяснение и forensic-трассировку общих правил купли-продажи по статьям 454–491 ГК РФ перед специальными правилами поставки `ru-v10`. Активная политика хранит одновременно:
