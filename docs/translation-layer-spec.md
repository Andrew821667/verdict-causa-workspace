...
`TranslationTemplateSet` содержит ровно один шаблон каждого уровня, локаль `ru-RU`, версию и SHA-256 hash канонического JSON. Версия `translation-template-ru-v2` добавляет профессиональное резюме контрфактической чувствительности и forensic-трассировку операторов. Активная политика хранит одновременно:
