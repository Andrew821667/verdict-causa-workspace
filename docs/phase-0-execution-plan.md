...
- `examples/migrations/contracts-ru-v0-0.1.0-to-0.12.0-migration-report.json`, generated by `scripts/export_contracts_package_migration_report.py`;
- `examples/migrations/contracts-ru-v0-0.3.0-to-0.12.0-migration-report.json`, generated by `scripts/export_contracts_package_migration_report.py`;
- `examples/migrations/contracts-ru-v0-0.4.0-to-0.12.0-migration-report.json`, generated by `scripts/export_contracts_package_migration_report.py`;
- `examples/migrations/contracts-ru-v0-0.5.0-to-0.12.0-migration-report.json`, generated by `scripts/export_contracts_package_migration_report.py`;
- `examples/migrations/contracts-ru-v0-0.6.0-to-0.12.0-migration-report.json`, generated by `scripts/export_contracts_package_migration_report.py`;
- `examples/migrations/contracts-ru-v0-0.7.0-to-0.12.0-migration-report.json`, generated by `scripts/export_contracts_package_migration_report.py`;
- `examples/migrations/contracts-ru-v0-0.8.0-to-0.12.0-migration-report.json`, generated by `scripts/export_contracts_package_migration_report.py`;
- `examples/migrations/contracts-ru-v0-0.9.0-to-0.12.0-migration-report.json`, generated by `scripts/export_contracts_package_migration_report.py`;
- `examples/migrations/contracts-ru-v0-0.10.0-to-0.12.0-migration-report.json`, generated by `scripts/export_contracts_package_migration_report.py`.
- `examples/migrations/contracts-ru-v0-0.11.0-to-0.12.0-migration-report.json`, generated by `scripts/export_contracts_package_migration_report.py`.
...
4. deterministic formation, change-and-termination, and obligation analysis, authority/source applicability checks, evidence mapping, liability prerequisites, and bounded counterfactual sensitivity;
