...
1. Complete machine-readable package manifest for contractual relations.
2. Add reviewed bootstrap JSON schema.
3. Add policy matrix for `mode x tier`.
4. Add governance profiles by candidate type.
5. Add sample synthetic decision trace.
