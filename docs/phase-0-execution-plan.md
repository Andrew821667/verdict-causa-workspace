...
- `examples/migrations/contracts-ru-v0-0.1.0-to-0.5.0-migration-report.json`, generated by `scripts/export_contracts_package_migration_report.py`;
- `examples/migrations/contracts-ru-v0-0.3.0-to-0.5.0-migration-report.json`, generated by `scripts/export_contracts_package_migration_report.py`;
- `examples/migrations/contracts-ru-v0-0.4.0-to-0.5.0-migration-report.json`, generated by `scripts/export_contracts_package_migration_report.py`.
...
9. `standard x T3` policy matrix entry;
