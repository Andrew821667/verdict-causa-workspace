...
- `examples/synthetic_sale_articles_454_491_report.json`, generated by `scripts/export_synthetic_sale_evaluation.py`;
- `examples/synthetic_supply_articles_506_524_report.json`, generated by `scripts/export_synthetic_supply_evaluation.py`;
...
- replay reports `examples/migrations/contracts-ru-v0-<source>-to-0.17.0-migration-report.json` for `0.1.0`, `0.3.0`, and every release from `0.4.0` through `0.16.0`, generated by `scripts/export_contracts_package_migration_report.py`.
...
4. deterministic formation, invalidity, obligation, performance-security, performance-remedies, general-sale, special-supply, change-and-termination, and liability analysis with authority/source applicability checks and bounded counterfactual sensitivity;
