...
4. Replace synthetic remedy, causation, and limitation facts with reviewed case-evidence mappings.
...
- `examples/migrations/contracts-ru-v0-0.1.0-to-0.3.0-migration-report.json`, generated by `scripts/export_contracts_package_migration_report.py`.
