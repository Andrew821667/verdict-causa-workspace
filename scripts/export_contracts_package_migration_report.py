...
def main() -> None:
    ...
    fixture_pairs = [
        (
            ...
            migrations_path / "contracts-ru-v0-0.1.0-to-0.6.0-migration-report.json",
        ),
        (
            migrations_path / "contracts-ru-v0-0.3.0-phase0-trace.json",
            migrations_path / "contracts-ru-v0-0.3.0-to-0.6.0-migration-report.json",
        ),
        (
            migrations_path / "contracts-ru-v0-0.4.0-reviewed-analysis.json",
            migrations_path / "contracts-ru-v0-0.4.0-to-0.6.0-migration-report.json",
        ),
        (
            migrations_path / "contracts-ru-v0-0.5.0-phase0-trace.json",
            migrations_path / "contracts-ru-v0-0.5.0-to-0.6.0-migration-report.json",
        ),
    ]
