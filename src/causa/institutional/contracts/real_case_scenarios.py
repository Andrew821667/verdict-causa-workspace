...
UNMAPPED_FINAL_CASES_RU: dict[str, str] = {
    "vs-41-kg21-49-k4": (
        "Спор разрешён по Закону об ОСАГО: право требовать возмещение деньгами вместо "
        "ремонта возникло из ненадлежащей организации восстановительного ремонта. "
        "Решающая норма лежит вне ГК РФ, и ни один институт пакета её не моделирует. "
        "Гражданский кодекс такого средства защиты не знает: ненадлежащее исполнение "
        "по статье 309 даёт убытки, а не замену способа исполнения.\n"
        "Перевести дело в модель заключения договора соблазнительно и неверно. Суд "
        "действительно установил, что согласие потерпевшего на использование бывших в "
        "употреблении деталей достигнуто не было, и модель статей 432–443 вывела бы "
        "отсюда незаключённость соглашения об условиях ремонта. Но дело не об этом "
        "соглашении: незаключённость здесь — посылка, а не вывод, и спор выигран не ею. "
        "Набор сверял бы тогда модель с обстоятельством, на котором дело не "
        "разрешалось, — и число переведённых дел выросло бы, а проверка ослабла. "
        "Статьи 421, 432, 927 и 929 названы в выгрузке как общее основание, и это "
        "верно: ни одна из них не несёт исхода дела."
    ),
}
