...
def build_invalidity_constraint_set(
    ...
    return InvalidityConstraintSet(
        ...
        expressions=[
            ...
            "consent_voidable_ground == required_consent_absent AND counterparty_knew_consent_absent",
            ...
            "mistake_voidable_ground == material_mistake_proven AND NOT mistake_risk_assumed",
            "monetary_restitution_issue == restitution_required AND NOT return_in_kind_possible AND value_of_performance_proven",
            "nullity_consequence_claimant_has_standing == nullity_consequences_requested AND (claimant_is_transaction_party OR claimant_legally_authorized OR nullity_legal_interest_proven)",
