...
CONTRACTS_PACKAGE_MANIFEST = InstitutionalPackageManifest(
    id="contracts-ru-v0",
    legal_institute="Договорные отношения: заключение, действительность, обеспечение, перемена лиц, изменение, расторжение, исполнение, прекращение и ответственность",
    version="0.15.0",
