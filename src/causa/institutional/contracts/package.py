...
CONTRACTS_PACKAGE_MANIFEST = InstitutionalPackageManifest(
    id="contracts-ru-v0",
    legal_institute="Договорные отношения: заключение, действительность, обеспечение, перемена лиц, исполнение, поставка, изменение, расторжение, прекращение и ответственность",
    version="0.16.0",
