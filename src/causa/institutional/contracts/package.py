...
CONTRACTS_PACKAGE_MANIFEST = InstitutionalPackageManifest(
    id="contracts-ru-v0",
    legal_institute="Договорные отношения: заключение, толкование, действие во времени, исковая давность, действительность, обеспечение, перемена лиц, исполнение, купля-продажа, поставка, изменение, расторжение, прекращение и ответственность",
    version="0.21.0",
