...
CONTRACTS_PACKAGE_MANIFEST = InstitutionalPackageManifest(
    id="contracts-ru-v0",
    legal_institute="Договорные отношения: свобода договора, цена, заключение, заключение в обязательном порядке и на торгах, предварительный договор, опцион на заключение договора, рамочный договор, абонентский договор, публичный договор, договор присоединения, договор в пользу третьего лица, форма, заверения об обстоятельствах, преддоговорная ответственность, толкование, действие во времени, исковая давность, действительность, обеспечение, перемена лиц, исполнение, купля-продажа, поставка, изменение, расторжение, прекращение и ответственность",
    version="0.32.0",
