...
SYNTHETIC_CONTRACT_SOURCES = [
    ...
    LegalSource(
        id="synthetic-ru-gk427-standard-terms-v1",
        title="Синтетическая проверенная модель примерных условий по статье 427 и пунктам 4-5 статьи 421 ГК РФ",
        source_type=SourceType.STATUTE,
        text=(
            "Синтетическое представление: договор может предусматривать, что его отдельные "
            "условия определяются примерными условиями, разработанными для договоров "
            "соответствующего вида и опубликованными в печати; если договор не содержит "
            "отсылки к таким примерным условиям, они применяются к отношениям сторон в "
            "качестве обычая, если отвечают требованиям статьи 5 ГК РФ, — но лишь тогда, "
            "когда условие не определено ни сторонами, ни диспозитивной нормой (статья 427, "
            "пункты 4 и 5 статьи 421 ГК РФ)."
        ),
        valid_from="1995-01-01",
        metadata={
            "synthetic": True,
            "topic": "standard_terms_article_427",
            "legal_reference": "ГК РФ, статья 427, пункты 4-5 статьи 421",
            "basis_url": "https://government.ru/docs/all/95825/",
            "review_required": True,
        },
    ),
    LegalSource(
        ...
        text=(
            ...
            "заключению отсутствует. Примерные условия сторонами не заявлялись и не "
            "применялись: все условия поставки согласованы сторонами напрямую."
        ),
        valid_from="2026-01-01",
        metadata={
            "synthetic": True,
    ...
    LegalSource(
        id="synthetic-ru-gk449-1-public-auction-v1",
        title="Синтетическая проверенная модель публичных торгов по статье 449.1 ГК РФ",
        source_type=SourceType.STATUTE,
        text=(
            "Синтетическое представление: публичными признаются торги, проводимые в целях "
            "исполнения решения суда или исполнительных документов в порядке исполнительного "
            "производства, и правила статей 448 и 449 применяются к ним, если иное не "
            "установлено Кодексом и процессуальным законодательством; организатором выступает "
            "лицо, уполномоченное отчуждать имущество в порядке исполнительного производства; "
            "извещение размещается на сайте органа, осуществляющего исполнительное "
            "производство, и указывает собственника имущества; в торгах не могут участвовать "
            "должник, организации, на которые возложены оценка и реализация его имущества, и "
            "их работники, должностные лица, чьё участие может повлиять на условия и "
            "результаты торгов, а также члены их семей; протокол о результатах указывает всех "
            "участников и внесённые ими предложения о цене (статья 449.1 ГК РФ)."
        ),
        valid_from="2015-06-01",
        metadata={
            "synthetic": True,
            "topic": "public_auction_article_449_1",
            "legal_reference": "ГК РФ, статья 449.1",
    ...
    LegalSource(
        id="synthetic-ru-gk844-1-precious-metal-deposit-v1",
        title="Синтетическая проверенная модель договора банковского вклада в драгоценных металлах по статье 844.1 ГК РФ",
        source_type=SourceType.STATUTE,
        text=(
            "Синтетическое представление: по договору банковского вклада в драгоценных "
            "металлах банк обязуется возвратить имеющийся во вкладе драгоценный металл того же "
            "наименования и той же массы либо выдать денежные средства в сумме, эквивалентной "
            "стоимости этого металла, и выплатить предусмотренные договором проценты; договор "
            "должен указывать наименование металла, размер процентов, форму их получения и "
            "порядок расчёта выдаваемой суммы; правила статьи 840 ГК РФ о страховании вкладов "
            "к такому вкладу не применяются, и гражданин должен быть уведомлён об этом в "
            "письменной форме до заключения договора с получением от него письменного "
            "подтверждения (статья 844.1 ГК РФ)."
        ),
        valid_from="2018-06-01",
        metadata={
            "synthetic": True,
            "topic": "precious_metal_deposit_article_844_1",
            "legal_reference": "ГК РФ, статья 844.1",
            "basis_url": "https://government.ru/docs/all/95825/",
            "review_required": True,
        },
    ),
    ...
    LegalSource(
        id="synthetic-ru-gk1012-1019-trust-management-concept-terms-and-property-v1",
        title="Синтетическая проверенная модель договора доверительного управления имуществом, объекта управления, требований к управляющему, существенных условий, формы и обособления имущества по статьям 1012–1019 ГК РФ",
        source_type=SourceType.STATUTE,
        text=(
            "Синтетическое представление: договор доверительного управления имуществом как "
            "передача учредителем управления имущества доверительному управляющему на "
            "определённый срок с обязанностью осуществлять управление в интересах учредителя или "
            "выгодоприобретателя, допустимые объекты доверительного управления, требования к "
            "доверительному управляющему, существенные условия и письменная форма договора с "
            "государственной регистрацией передачи недвижимости, обособление переданного "
            "имущества и предупреждение управляющего об обременении залогом проверяются раздельно "
            "(статьи 1012–1019 ГК РФ)."
        ),
        valid_from="1996-03-01",
        metadata={
            "synthetic": True,
            "topic": "trust_management_concept_terms_and_property_articles_1012_1019",
            "legal_reference": "ГК РФ, статьи 1012–1019",
            "basis_url": "https://government.ru/docs/all/95825/",
            "review_required": True,
        },
    ),
    LegalSource(
        id="synthetic-ru-gk1020-1026-trust-management-duties-liability-and-termination-v1",
        title="Синтетическая проверенная модель прав и обязанностей доверительного управляющего, его ответственности, вознаграждения и прекращения договора по статьям 1020–1026 ГК РФ",
        source_type=SourceType.STATUTE,
        text=(
            "Синтетическое представление: осуществление доверительным управляющим правомочий "
            "собственника в пределах закона и договора, представление отчёта учредителю "
            "управления и выгодоприобретателю, личное осуществление управления и допустимость "
            "поручения его другому лицу, ответственность управляющего за отсутствие должной "
            "заботливости, право на вознаграждение и возмещение расходов, а также основания "
            "прекращения договора доверительного управления проверяются раздельно "
            "(статьи 1020–1026 ГК РФ)."
        ),
        valid_from="1996-03-01",
        metadata={
            "synthetic": True,
            "topic": "trust_management_duties_liability_and_termination_articles_1020_1026",
            "legal_reference": "ГК РФ, статьи 1020–1026",
            "basis_url": "https://government.ru/docs/all/95825/",
            "review_required": True,
        },
    ),
    LegalSource(
        id="synthetic-case-supply-1-trust-management-evidence",
        title="Синтетическая проверенная запись фактов о доверительном управлении имуществом",
        source_type=SourceType.FACT,
        text=(
            "Синтетическая запись: по спорному договору поставки имущество в доверительное "
            "управление не передавалось; договор доверительного управления имуществом между "
            "сторонами не заключался."
        ),
        valid_from="2026-01-01",
        metadata={
            "synthetic": True,
            "non_authoritative": True,
            "topic": "trust_management_case_evidence",
            "case_id": "case-supply-1",
        },
    ),
    LegalSource(
        id="synthetic-ru-gk128-136-objects-circulation-and-kinds-of-things-v1",
        title="Синтетическая проверенная модель объектов гражданских прав, их оборотоспособности и видов вещей по статьям 128–136 ГК РФ",
        source_type=SourceType.STATUTE,
        text=(
            "Синтетическое представление: перечень объектов гражданских прав, включая вещи, "
            "имущественные права, результаты работ и оказание услуг, охраняемые результаты "
            "интеллектуальной деятельности и нематериальные блага, свободное отчуждение "
            "объектов, не ограниченных в обороте, деление вещей на недвижимые и движимые, "
            "неделимые и сложные вещи, следование принадлежности судьбе главной вещи и "
            "принадлежность плодов, продукции и доходов собственнику вещи проверяются "
            "раздельно (статьи 128–136 ГК РФ)."
        ),
        valid_from="1995-01-01",
        metadata={
            "synthetic": True,
            "topic": "objects_circulation_and_kinds_of_things_articles_128_136",
            "legal_reference": "ГК РФ, статьи 128–136",
            "basis_url": "https://government.ru/docs/all/95820/",
            "review_required": True,
        },
    ),
    LegalSource(
        id="synthetic-ru-gk140-152-money-securities-and-intangible-benefits-v1",
        title="Синтетическая проверенная модель денег, ценных бумаг и нематериальных благ по статьям 140–152 ГК РФ",
        source_type=SourceType.STATUTE,
        text=(
            "Синтетическое представление: рубль как законное платёжное средство, обязательное "
            "к приёму по нарицательной стоимости, удостоверение прав ценными бумагами по "
            "правилам закона, неотчуждаемость и непередаваемость нематериальных благ, включая "
            "жизнь и здоровье, достоинство личности, честь и доброе имя и деловую репутацию, "
            "а также право требовать по суду опровержения порочащих сведений проверяются "
            "раздельно (статьи 140–152 ГК РФ)."
        ),
        valid_from="1995-01-01",
        metadata={
            "synthetic": True,
            "topic": "money_securities_and_intangible_benefits_articles_140_152",
            "legal_reference": "ГК РФ, статьи 140–152",
            "basis_url": "https://government.ru/docs/all/95820/",
            "review_required": True,
        },
    ),
    LegalSource(
        id="synthetic-case-supply-1-objects-evidence",
        title="Синтетическая проверенная запись фактов об объекте спорного договора",
        source_type=SourceType.FACT,
        text=(
            "Синтетическая запись: предметом спорного договора поставки является движимое "
            "имущество, не изъятое из оборота и не ограниченное в обороте; самостоятельных "
            "возражений об объекте гражданских прав не заявлялось."
        ),
        valid_from="2026-01-01",
        metadata={
            "synthetic": True,
            "non_authoritative": True,
            "topic": "objects_case_evidence",
            "case_id": "case-supply-1",
        },
    ),
    LegalSource(
        id="synthetic-ru-gk17-30-legal-and-active-capacity-of-citizens-v1",
        title="Синтетическая проверенная модель правоспособности и дееспособности граждан по статьям 17–30 ГК РФ",
        source_type=SourceType.STATUTE,
        text=(
            "Синтетическое представление: возникновение правоспособности гражданина в момент "
            "рождения и её содержание, недопустимость сделок, направленных на ограничение "
            "правоспособности и дееспособности, возникновение дееспособности в полном объёме с "
            "наступлением совершеннолетия, особые правила о сделках несовершеннолетних, "
            "признание гражданина недееспособным вследствие психического расстройства и "
            "совершение сделок от его имени опекуном, а также ограничение дееспособности "
            "судом и совершение сделок с согласия попечителя проверяются раздельно "
            "(статьи 17–30 ГК РФ)."
        ),
        valid_from="1995-01-01",
        metadata={
            "synthetic": True,
            "topic": "legal_and_active_capacity_of_citizens_articles_17_30",
            "legal_reference": "ГК РФ, статьи 17–30",
            "basis_url": "https://government.ru/docs/all/95820/",
            "review_required": True,
        },
    ),
    LegalSource(
        id="synthetic-ru-gk49-53-capacity-registration-and-bodies-of-legal-entities-v1",
        title="Синтетическая проверенная модель правоспособности, регистрации и органов юридического лица по статьям 49–53 ГК РФ",
        source_type=SourceType.STATUTE,
        text=(
            "Синтетическое представление: правоспособность юридического лица и её соответствие "
            "целям деятельности, осуществление отдельных видов деятельности на основании "
            "лицензии или членства в саморегулируемой организации, государственная регистрация "
            "юридического лица и его создание со дня внесения записи в единый государственный "
            "реестр, а также приобретение юридическим лицом прав и обязанностей через свои "
            "органы и обязанность этих органов действовать добросовестно и разумно "
            "проверяются раздельно (статьи 49–53 ГК РФ)."
        ),
        valid_from="1995-01-01",
        metadata={
            "synthetic": True,
            "topic": "capacity_registration_and_bodies_of_legal_entities_articles_49_53",
            "legal_reference": "ГК РФ, статьи 49–53",
            "basis_url": "https://government.ru/docs/all/95820/",
            "review_required": True,
        },
    ),
    LegalSource(
        id="synthetic-case-supply-1-persons-evidence",
        title="Синтетическая проверенная запись фактов о правоспособности и дееспособности сторон",
        source_type=SourceType.FACT,
        text=(
            "Синтетическая запись: обе стороны спорного договора поставки — действующие "
            "юридические лица, вопросов об их правоспособности и о дееспособности граждан не "
            "заявлялось."
        ),
        valid_from="2026-01-01",
        metadata={
            "synthetic": True,
            "non_authoritative": True,
            "topic": "persons_case_evidence",
            "case_id": "case-supply-1",
        },
    ),
    LegalSource(
        id="synthetic-ru-gk190-193-term-definition-start-and-end-v1",
        title="Синтетическая проверенная модель определения срока, начала его течения и окончания по статьям 190–193 ГК РФ",
        source_type=SourceType.STATUTE,
        text=(
            "Синтетическое представление: определение срока календарной датой, истечением "
            "периода времени, исчисляемого годами, месяцами, неделями, днями или часами, либо "
            "указанием на событие, которое должно неизбежно наступить, начало течения срока "
            "на следующий день после календарной даты или наступления события, окончание "
            "срока, исчисляемого годами, месяцами, кварталами, полугодиями, неделями и "
            "полумесяцами, а также перенос окончания срока, приходящегося на нерабочий день, "
            "на ближайший следующий за ним рабочий день проверяются раздельно "
            "(статьи 190–193 ГК РФ)."
        ),
        valid_from="1995-01-01",
        metadata={
            "synthetic": True,
            "topic": "term_definition_start_and_end_articles_190_193",
            "legal_reference": "ГК РФ, статьи 190–193",
            "basis_url": "https://government.ru/docs/all/95820/",
            "review_required": True,
        },
    ),
    LegalSource(
        id="synthetic-ru-gk194-actions-on-the-last-day-of-a-term-v1",
        title="Синтетическая проверенная модель порядка совершения действий в последний день срока по статье 194 ГК РФ",
        source_type=SourceType.STATUTE,
        text=(
            "Синтетическое представление: возможность выполнить действие до двадцати четырёх "
            "часов последнего дня срока, истечение срока в тот час, когда в организации по "
            "установленным правилам прекращаются соответствующие операции, а также признание "
            "совершёнными в срок письменных заявлений и извещений, сданных в организацию "
            "связи до двадцати четырёх часов последнего дня срока, проверяются раздельно "
            "(статья 194 ГК РФ)."
        ),
        valid_from="1995-01-01",
        metadata={
            "synthetic": True,
            "topic": "actions_on_the_last_day_of_a_term_article_194",
            "legal_reference": "ГК РФ, статья 194",
            "basis_url": "https://government.ru/docs/all/95820/",
            "review_required": True,
        },
    ),
    ...
    LegalSource(
        id="synthetic-ru-gk1651-legally-significant-messages-v1",
        title="Синтетическая проверенная модель юридически значимых сообщений по статье 165.1 ГК РФ",
        source_type=SourceType.STATUTE,
        text=(
            "Синтетическое представление: заявления, уведомления, извещения, требования и "
            "иные сообщения, с которыми закон или сделка связывает гражданско-правовые "
            "последствия для другого лица, влекут эти последствия с момента доставки "
            "сообщения ему или его представителю; сообщение считается доставленным и тогда, "
            "когда оно поступило адресату, но по обстоятельствам, зависящим от него, не было "
            "вручено или адресат с ним не ознакомился; правило применяется, если иное не "
            "предусмотрено законом или условиями сделки либо не следует из обычая или из "
            "практики, установившейся во взаимоотношениях сторон (статья 165.1 ГК РФ)."
        ),
        valid_from="2013-09-01",
        metadata={
            "synthetic": True,
            "topic": "legally_significant_messages_article_165_1",
            "legal_reference": "ГК РФ, статья 165.1",
            "basis_url": "https://government.ru/docs/all/95820/",
            "review_required": True,
        },
    ),
    LegalSource(
        id="synthetic-ru-plenum25-63-67-message-delivery-risk-v1",
        title="Синтетическая проверенная модель риска неполучения сообщения по пунктам 63–68 постановления Пленума ВС РФ № 25",
        source_type=SourceType.STATUTE,
        text=(
            "Синтетическое представление: юридически значимое сообщение направляется по "
            "адресу из реестра, по месту жительства гражданина либо по адресу, названному "
            "самим адресатом; сообщение может быть направлено в любой форме, позволяющей "
            "достоверно установить, от кого оно исходило и кому адресовано; риск "
            "неполучения корреспонденции по надлежащему адресу несёт адресат (пункты 63, 65 "
            "и 67 постановления Пленума Верховного Суда РФ от 23.06.2015 № 25)."
        ),
        valid_from="2015-06-23",
        metadata={
            "synthetic": True,
            "topic": "message_delivery_risk_plenum_25",
            "legal_reference": "Постановление Пленума ВС РФ от 23.06.2015 N 25, пункты 63-68",
            "basis_url": "https://government.ru/docs/all/95820/",
            "review_required": True,
        },
    ),
    LegalSource(
        id="synthetic-case-supply-1-messages-evidence",
        title="Синтетическая проверенная запись фактов о юридически значимом сообщении по делу",
        source_type=SourceType.FACT,
        text=(
            "Синтетическая запись: претензия покупателя вручена поставщику под подпись "
            "уполномоченного представителя; иного правила доставки договор поставки не "
            "устанавливает."
        ),
        valid_from="2026-01-01",
        metadata={
            "synthetic": True,
            "non_authoritative": True,
            "topic": "messages_case_evidence",
            "case_id": "case-supply-1",
        },
    ),
    LegalSource(
        id="synthetic-ru-gk8601-8606-nominal-account-v1",
        title="Синтетическая проверенная модель номинального счёта по статьям 860.1–860.6 ГК РФ",
        source_type=SourceType.STATUTE,
        text=(
            "Синтетическое представление: номинальный счёт открывается владельцу счёта для "
            "совершения операций с деньгами, права на которые принадлежат другому лицу — "
            "бенефициару; договор заключается в письменной форме путём составления одного "
            "документа, подписанного сторонами, несоблюдение формы влечёт ничтожность "
            "договора; существенным условием является указание бенефициара либо порядка "
            "получения сведений о нём; банк может принять на себя обязанность "
            "контролировать распоряжение деньгами в интересах бенефициара; бенефициар "
            "вправе требовать сведения по счёту; договор с участием бенефициара изменяется "
            "и расторгается только с его согласия; арест и списание по обязательствам "
            "владельца счёта не допускаются, но допускаются по обязательствам бенефициара "
            "(статьи 860.1–860.6 ГК РФ)."
        ),
        valid_from="2014-07-01",
        metadata={
            "synthetic": True,
            "topic": "nominal_account_articles_860_1_860_6",
            "legal_reference": "ГК РФ, статьи 860.1-860.6",
            "basis_url": "https://government.ru/docs/all/95820/",
            "review_required": True,
        },
    ),
    LegalSource(
        id="synthetic-ru-gk8607-86010-escrow-account-v1",
        title="Синтетическая проверенная модель счёта эскроу по статьям 860.7–860.10 ГК РФ",
        source_type=SourceType.STATUTE,
        text=(
            "Синтетическое представление: по договору счёта эскроу банк блокирует "
            "полученную от депонента сумму и передаёт её бенефициару при возникновении "
            "оснований, предусмотренных договором; до наступления этих оснований ни "
            "депонент, ни бенефициар не вправе распоряжаться деньгами на счёте; зачисление "
            "на счёт эскроу иных денег депонента не допускается; арест и списание по "
            "обязательствам владельца счёта не допускаются; при истечении срока договора "
            "без наступления оснований остаток возвращается депоненту, если договором не "
            "предусмотрено иное (статьи 860.7–860.10 ГК РФ)."
        ),
        valid_from="2014-07-01",
        metadata={
            "synthetic": True,
            "topic": "escrow_account_articles_860_7_860_10",
            "legal_reference": "ГК РФ, статьи 860.7-860.10",
            "basis_url": "https://government.ru/docs/all/95820/",
            "review_required": True,
        },
    ),
    LegalSource(
        id="synthetic-ru-gk86011-86015-public-deposit-account-v1",
        title="Синтетическая проверенная модель публичного депозитного счёта по статьям 860.11–860.15 ГК РФ",
        source_type=SourceType.STATUTE,
        text=(
            "Синтетическое представление: публичный депозитный счёт открывается нотариусу, "
            "службе судебных приставов, суду или иному органу, которому закон разрешает "
            "принимать деньги в депозит, в банке, размер собственных средств которого "
            "отвечает установленному требованию; зачисление на счёт собственных денег "
            "владельца не допускается; на депонированную сумму начисляются проценты, "
            "которые выплачиваются бенефициару; арест, приостановление операций и списание "
            "не допускаются ни по обязательствам владельца счёта, ни по обязательствам "
            "бенефициара, ни по обязательствам депонента (статьи 860.11–860.15 ГК РФ)."
        ),
        valid_from="2018-06-01",
        metadata={
            "synthetic": True,
            "topic": "public_deposit_account_articles_860_11_860_15",
            "legal_reference": "ГК РФ, статьи 860.11-860.15",
            "basis_url": "https://government.ru/docs/all/95820/",
            "review_required": True,
        },
    ),
    LegalSource(
        id="synthetic-case-supply-1-special-accounts-evidence",
        title="Синтетическая проверенная запись фактов о специальном банковском счёте по делу",
        source_type=SourceType.FACT,
        text=(
            "Синтетическая запись: расчёты по договору поставки велись обычным платёжным "
            "поручением с расчётного счёта покупателя; ни номинального счёта, ни счёта "
            "эскроу, ни публичного депозитного счёта стороны не открывали. Специальный "
            "вид банковского счёта в деле не заявлен."
        ),
        valid_from="2026-01-01",
        metadata={
            "synthetic": True,
            "non_authoritative": True,
            "topic": "special_accounts_case_evidence",
            "case_id": "case-supply-1",
        },
    ),
    LegalSource(
        id="synthetic-ru-gk9261-9268-escrow-deposit-v1",
        title="Синтетическая проверенная модель условного депонирования (эскроу) по статьям 926.1–926.8 ГК РФ",
        source_type=SourceType.STATUTE,
        text=(
            "Синтетическое представление: по договору эскроу депонент передаёт "
            "эскроу-агенту имущество для передачи бенефициару при наступлении "
            "предусмотренных договором оснований; сторонами договора выступают "
            "депонент, бенефициар и эскроу-агент; договор подлежит нотариальному "
            "удостоверению, кроме депонирования исключительно безналичных денег и "
            "(или) бездокументарных ценных бумаг; срок депонирования не может "
            "превышать пять лет, а без указания срока или при большем сроке договор "
            "считается заключённым на пять лет; эскроу-агент вправе на вознаграждение, "
            "обязан обособить депонированное имущество и не вправе им пользоваться и "
            "распоряжаться, если иное не предусмотрено договором или не следует из "
            "существа обязательства; при депонировании вещей право собственности на "
            "них сохраняется за депонентом до наступления оснований передачи, а после "
            "этого переходит к бенефициару, и агент отвечает за их утрату, недостачу "
            "или повреждение, если не докажет непреодолимую силу, неизвестное ему "
            "свойство вещей либо умысел или грубую неосторожность депонента; при "
            "депонировании безналичных денег эскроу-агентом, не являющимся банком, "
            "деньги депонируются на его номинальном счёте; обращение взыскания, арест "
            "и обеспечительные меры по долгам эскроу-агента и депонента на "
            "депонированное имущество не допускаются, а по долгам бенефициара "
            "взыскание может быть обращено на его право требования к агенту "
            "(статьи 926.1–926.8 ГК РФ)."
        ),
        valid_from="2018-06-01",
        metadata={
            "synthetic": True,
            "topic": "escrow_deposit_articles_926_1_926_8",
            "legal_reference": "ГК РФ, статьи 926.1-926.8",
            "basis_url": "https://government.ru/docs/all/95820/",
            "review_required": True,
        },
    ),
    LegalSource(
        id="synthetic-case-supply-1-escrow-deposit-evidence",
        title="Синтетическая проверенная запись фактов об условном депонировании по делу",
        source_type=SourceType.FACT,
        text=(
            "Синтетическая запись: расчёты по договору поставки велись обычным "
            "платёжным поручением; договор условного депонирования (эскроу) стороны не "
            "заключали. Институт в деле не заявлен."
        ),
        valid_from="2026-01-01",
        metadata={
            "synthetic": True,
            "non_authoritative": True,
            "topic": "escrow_deposit_case_evidence",
            "case_id": "case-supply-1",
        },
    ),
    LegalSource(
    ...
    LegalSource(
        ...
        source_type=SourceType.FACT,
        text=(
            "Синтетическая запись: по спорному договору поставки самостоятельных возражений "
            "об исчислении сроков не заявлялось."
        ),
        valid_from="2026-01-01",
        metadata={
            "synthetic": True,
            "non_authoritative": True,
            "topic": "terms_case_evidence",
            "case_id": "case-supply-1",
        },
    ),
    LegalSource(
        id="synthetic-ru-gk153-157-transaction-concept-kinds-and-conditions-v1",
        title="Синтетическая проверенная модель понятия сделки, её видов и сделок под условием по статьям 153–157 ГК РФ",
        source_type=SourceType.STATUTE,
        text=(
            "Синтетическое представление: признание сделками действий граждан и юридических "
            "лиц, направленных на установление, изменение или прекращение гражданских прав и "
            "обязанностей, деление сделок на односторонние и двух- или многосторонние, "
            "создание односторонней сделкой обязанностей для совершившего её лица, применение "
            "к односторонним сделкам общих положений об обязательствах и о договорах, а также "
            "совершение сделки под отлагательным или отменительным условием и последствия "
            "недобросовестного воспрепятствования или содействия наступлению условия "
            "проверяются раздельно (статьи 153–157 ГК РФ)."
        ),
        valid_from="1995-01-01",
        metadata={
            "synthetic": True,
            "topic": "transaction_concept_kinds_and_conditions_articles_153_157",
            "legal_reference": "ГК РФ, статьи 153–157",
            "basis_url": "https://government.ru/docs/all/95820/",
            "review_required": True,
        },
    ),
    LegalSource(
        id="synthetic-ru-gk157-1-consent-to-a-transaction-v1",
        title="Синтетическая проверенная модель согласия на совершение сделки по статье 157.1 ГК РФ",
        source_type=SourceType.STATUTE,
        text=(
            "Синтетическое представление: необходимость согласия третьего лица, органа "
            "юридического лица, государственного органа или органа местного самоуправления на "
            "совершение сделки, определение предмета сделки в предварительном согласии, "
            "указание сделки в последующем согласии (одобрении), а также правило о том, что "
            "молчание не считается согласием на совершение сделки, за исключением случаев, "
            "установленных законом, проверяются раздельно (статья 157.1 ГК РФ)."
        ),
        valid_from="2013-09-01",
        metadata={
            "synthetic": True,
            "topic": "consent_to_a_transaction_article_157_1",
            "legal_reference": "ГК РФ, статья 157.1",
            "basis_url": "https://government.ru/docs/all/95820/",
            "review_required": True,
        },
    ),
    LegalSource(
        id="synthetic-case-supply-1-transactions-evidence",
        title="Синтетическая проверенная запись фактов о понятии, виде и условиях сделки",
        source_type=SourceType.FACT,
        text=(
            "Синтетическая запись: спорный договор поставки заключён как двусторонняя сделка "
            "без отлагательных и отменительных условий; согласия третьих лиц или органов на "
            "его совершение по закону не требовалось."
        ),
        valid_from="2026-01-01",
        metadata={
            "synthetic": True,
            "non_authoritative": True,
            "topic": "transactions_case_evidence",
            "case_id": "case-supply-1",
        },
    ),
    LegalSource(
        id="synthetic-ru-gk1-10-civil-principles-and-limits-of-exercise-v1",
        title="Синтетическая проверенная модель основных начал гражданского законодательства, оснований возникновения прав и пределов их осуществления по статьям 1–10 ГК РФ",
        source_type=SourceType.STATUTE,
        text=(
            "Синтетическое представление: равенство участников оборота, неприкосновенность "
            "собственности, свобода договора и недопустимость произвольного вмешательства в "
            "частные дела, требование добросовестности при установлении, осуществлении и защите "
            "прав, запрет извлекать преимущество из незаконного или недобросовестного "
            "поведения, основания возникновения гражданских прав и обязанностей, а также запрет "
            "злоупотребления правом и отказ суда в защите права при его нарушении проверяются "
            "раздельно (статьи 1–10 ГК РФ)."
        ),
        valid_from="1995-01-01",
        metadata={
            "synthetic": True,
            "topic": "civil_principles_and_limits_of_exercise_articles_1_10",
            "legal_reference": "ГК РФ, статьи 1–10",
            "basis_url": "https://government.ru/docs/all/95820/",
            "review_required": True,
        },
    ),
    LegalSource(
        id="synthetic-ru-gk12-16-1-protection-methods-damages-and-authority-liability-v1",
        title="Синтетическая проверенная модель способов защиты гражданских прав, самозащиты, возмещения убытков и ответственности публично-правовых образований по статьям 12–16.1 ГК РФ",
        source_type=SourceType.STATUTE,
        text=(
            "Синтетическое представление: перечень способов защиты гражданских прав, "
            "допустимость самозащиты и требование её соразмерности нарушению, право требовать "
            "полного возмещения убытков, включая реальный ущерб и упущенную выгоду, а также "
            "возмещение убытков, причинённых незаконными действиями органов власти, и "
            "компенсация ущерба, причинённого правомерными действиями таких органов, "
            "проверяются раздельно (статьи 12–16.1 ГК РФ)."
        ),
        valid_from="1995-01-01",
        metadata={
            "synthetic": True,
            "topic": "protection_methods_damages_and_authority_liability_articles_12_16_1",
            "legal_reference": "ГК РФ, статьи 12–16.1",
            "basis_url": "https://government.ru/docs/all/95820/",
            "review_required": True,
        },
    ),
    LegalSource(
        id="synthetic-case-supply-1-civil-principles-evidence",
        title="Синтетическая проверенная запись фактов об основных началах и защите гражданских прав",
        source_type=SourceType.FACT,
        text=(
            "Синтетическая запись: по спорному договору поставки о злоупотреблении правом и "
            "нарушении основных начал гражданского законодательства не заявлялось."
        ),
        valid_from="2026-01-01",
        metadata={
            "synthetic": True,
            "non_authoritative": True,
            "topic": "civil_principles_case_evidence",
            "case_id": "case-supply-1",
        },
    ),
    LegalSource(
        id="synthetic-ru-gk209-234-ownership-content-acquisition-and-prescription-v1",
        title="Синтетическая проверенная модель содержания права собственности, бремени содержания и риска, оснований приобретения, момента возникновения права и приобретательной давности по статьям 209–234 ГК РФ",
        source_type=SourceType.STATUTE,
        text=(
            "Синтетическое представление: правомочия владения, пользования и распоряжения "
            "имуществом и их осуществление в установленных законом пределах, бремя содержания "
            "имущества и риск случайной гибели, основания приобретения права собственности, "
            "возникновение права у приобретателя по договору с момента передачи вещи или "
            "государственной регистрации отчуждения, а также приобретение права по давности "
            "владения проверяются раздельно (статьи 209–234 ГК РФ)."
        ),
        valid_from="1995-01-01",
        metadata={
            "synthetic": True,
            "topic": "ownership_content_acquisition_and_prescription_articles_209_234",
            "legal_reference": "ГК РФ, статьи 209–234",
            "basis_url": "https://government.ru/docs/all/95820/",
            "review_required": True,
        },
    ),
    LegalSource(
        id="synthetic-ru-gk244-305-common-property-and-protection-of-rights-v1",
        title="Синтетическая проверенная модель общей собственности, истребования имущества из чужого незаконного владения, защиты добросовестного приобретателя и негаторной защиты по статьям 244–305 ГК РФ",
        source_type=SourceType.STATUTE,
        text=(
            "Синтетическое представление: владение, пользование и распоряжение имуществом в "
            "общей долевой и совместной собственности по соглашению участников, право "
            "собственника истребовать имущество из чужого незаконного владения, ограничения "
            "истребования у возмездного добросовестного приобретателя и невозможность "
            "истребования у него денег и ценных бумаг на предъявителя, а также требование об "
            "устранении нарушений права, не соединённых с лишением владения, и защита "
            "владельца, не являющегося собственником, проверяются раздельно "
            "(статьи 244–305 ГК РФ)."
        ),
        valid_from="1995-01-01",
        metadata={
            "synthetic": True,
            "topic": "common_property_and_protection_of_rights_articles_244_305",
            "legal_reference": "ГК РФ, статьи 244–305",
            "basis_url": "https://government.ru/docs/all/95820/",
            "review_required": True,
        },
    ),
    LegalSource(
        id="synthetic-ru-gk306-statutory-termination-compensation-v1",
        title="Синтетическая проверенная модель последствий прекращения права собственности в силу закона по статье 306 ГК РФ",
        source_type=SourceType.STATUTE,
        text=(
            "Синтетическое представление: в случае принятия Российской Федерацией закона, "
            "прекращающего право собственности, убытки, причинённые собственнику в результате "
            "принятия этого акта, в том числе стоимость имущества, возмещаются государством; "
            "споры о возмещении убытков разрешаются судом (статья 306 ГК РФ)."
        ),
        valid_from="1995-01-01",
        metadata={
            "synthetic": True,
            "topic": "statutory_termination_compensation_article_306",
            "legal_reference": "ГК РФ, статья 306",
            "basis_url": "https://government.ru/docs/all/95820/",
            "review_required": True,
        },
    ),
    LegalSource(
        id="synthetic-case-supply-1-property-rights-evidence",
        title="Синтетическая проверенная запись фактов о вещных правах",
        source_type=SourceType.FACT,
        text=(
            "Синтетическая запись: по спорному договору поставки вещно-правовые требования не "
            "заявлялись; принадлежность товара продавцу не оспаривалась."
        ),
        valid_from="2026-01-01",
        metadata={
            "synthetic": True,
            "non_authoritative": True,
            "topic": "property_rights_case_evidence",
            "case_id": "case-supply-1",
        },
    ),
    LegalSource(
        id="synthetic-ru-gk182-184-representation-authority-and-limits-v1",
        title="Синтетическая проверенная модель представительства, оснований полномочия, запрета сделок в отношении себя лично, последствий сделки неуполномоченного лица и коммерческого представительства по статьям 182–184 ГК РФ",
        source_type=SourceType.STATUTE,
        text=(
            "Синтетическое представление: совершение сделки представителем от имени "
            "представляемого в силу полномочия, основанного на доверенности, указании закона "
            "или акте уполномоченного органа либо явствующего из обстановки, запрет совершения "
            "представителем сделок в отношении себя лично и в отношении другого представляемого "
            "им лица, правило о том, что при отсутствии полномочий сделка считается заключённой "
            "от имени совершившего её лица до её одобрения представляемым, а также правила о "
            "коммерческом представительстве проверяются раздельно (статьи 182–184 ГК РФ)."
        ),
        valid_from="1995-01-01",
        metadata={
            "synthetic": True,
            "topic": "representation_authority_and_limits_articles_182_184",
            "legal_reference": "ГК РФ, статьи 182–184",
            "basis_url": "https://government.ru/docs/all/95820/",
            "review_required": True,
        },
    ),
    LegalSource(
        id="synthetic-ru-gk185-189-power-of-attorney-form-term-and-termination-v1",
        title="Синтетическая проверенная модель доверенности, её формы и удостоверения, срока, передоверия и прекращения по статьям 185–189 ГК РФ",
        source_type=SourceType.STATUTE,
        text=(
            "Синтетическое представление: письменное уполномочие как доверенность, требования к "
            "нотариальному удостоверению доверенностей на сделки нотариальной формы и на "
            "распоряжение зарегистрированными правами, сохранение силы доверенности в течение "
            "года при отсутствии указания срока и ничтожность доверенности без даты её "
            "совершения, условия и порядок передоверия с обязанностью известить выдавшего "
            "доверенность, а также основания прекращения доверенности и обязанность известить о "
            "её отмене проверяются раздельно (статьи 185–189 ГК РФ)."
        ),
        valid_from="1995-01-01",
        metadata={
            "synthetic": True,
            "topic": "power_of_attorney_form_term_and_termination_articles_185_189",
            "legal_reference": "ГК РФ, статьи 185–189",
            "basis_url": "https://government.ru/docs/all/95820/",
            "review_required": True,
        },
    ),
    LegalSource(
        id="synthetic-case-supply-1-representation-evidence",
        title="Синтетическая проверенная запись фактов о представительстве и доверенности",
        source_type=SourceType.FACT,
        text=(
            "Синтетическая запись: спорный договор поставки подписан уполномоченными органами "
            "сторон без участия представителей по доверенности; отношения представительства не "
            "устанавливались."
        ),
        valid_from="2026-01-01",
        metadata={
            "synthetic": True,
            "non_authoritative": True,
            "topic": "representation_case_evidence",
            "case_id": "case-supply-1",
        },
    ),
    LegalSource(
        id="synthetic-ru-gk1102-1105-unjust-enrichment-duty-and-return-v1",
        title="Синтетическая проверенная модель обязанности возвратить неосновательное обогащение, соотношения с другими требованиями и возврата обогащения в натуре и по стоимости по статьям 1102–1105 ГК РФ",
        source_type=SourceType.STATUTE,
        text=(
            "Синтетическое представление: обязанность лица, без установленных законом, иными "
            "правовыми актами или сделкой оснований приобретшего или сберёгшего имущество за "
            "счёт другого лица, возвратить неосновательное обогащение, применение правил "
            "независимо от причин обогащения, их применение к требованиям о возврате "
            "исполненного по недействительной сделке, об истребовании имущества из чужого "
            "незаконного владения и о возмещении вреда, а также возврат обогащения в натуре и "
            "возмещение его действительной стоимости проверяются раздельно "
            "(статьи 1102–1105 ГК РФ)."
        ),
        valid_from="1996-03-01",
        metadata={
            "synthetic": True,
            "topic": "unjust_enrichment_duty_and_return_articles_1102_1105",
            "legal_reference": "ГК РФ, статьи 1102–1105",
            "basis_url": "https://government.ru/docs/all/95825/",
            "review_required": True,
        },
    ),
    LegalSource(
        id="synthetic-ru-gk1106-1109-unjust-enrichment-income-costs-and-exceptions-v1",
        title="Синтетическая проверенная модель последствий неосновательной передачи права, возмещения доходов и затрат и имущества, не подлежащего возврату, по статьям 1106–1109 ГК РФ",
        source_type=SourceType.STATUTE,
        text=(
            "Синтетическое представление: право лица, передавшего принадлежащее ему право на "
            "основании несуществующего или недействительного обязательства, требовать "
            "восстановления прежнего положения, обязанность приобретателя возвратить доходы и "
            "уплатить проценты за пользование чужими средствами, право приобретателя на "
            "возмещение необходимых затрат на содержание и сохранение имущества, а также "
            "перечень имущества, не подлежащего возврату в качестве неосновательного "
            "обогащения, проверяются раздельно (статьи 1106–1109 ГК РФ)."
        ),
        valid_from="1996-03-01",
        metadata={
            "synthetic": True,
            "topic": "unjust_enrichment_income_costs_and_exceptions_articles_1106_1109",
            "legal_reference": "ГК РФ, статьи 1106–1109",
            "basis_url": "https://government.ru/docs/all/95825/",
            "review_required": True,
        },
    ),
    LegalSource(
        id="synthetic-case-supply-1-unjust-enrichment-evidence",
        title="Синтетическая проверенная запись фактов о неосновательном обогащении",
        source_type=SourceType.FACT,
        text=(
            "Синтетическая запись: по спорному договору поставки имущество приобреталось на "
            "основании заключённого договора; неосновательное обогащение сторон не "
            "устанавливалось."
        ),
        valid_from="2026-01-01",
        metadata={
            "synthetic": True,
            "non_authoritative": True,
            "topic": "unjust_enrichment_case_evidence",
            "case_id": "case-supply-1",
        },
    ),
    LegalSource(
        id="synthetic-ru-gk1099-1100-moral-harm-grounds-and-no-fault-cases-v1",
        title="Синтетическая проверенная модель общих положений о компенсации морального вреда и оснований компенсации независимо от вины причинителя по статьям 1099 и 1100 ГК РФ",
        source_type=SourceType.STATUTE,
        text=(
            "Синтетическое представление: определение оснований и размера компенсации "
            "морального вреда правилами главы 59 и статьи 151 ГК РФ, компенсация морального "
            "вреда, причинённого нарушением имущественных прав, только в предусмотренных "
            "законом случаях, независимость компенсации от возмещения имущественного вреда, а "
            "также случаи компенсации независимо от вины причинителя — вред источником "
            "повышенной опасности, незаконное осуждение и привлечение к ответственности, "
            "распространение порочащих сведений — проверяются раздельно "
            "(статьи 1099 и 1100 ГК РФ)."
        ),
        valid_from="1996-03-01",
        metadata={
            "synthetic": True,
            "topic": "moral_harm_grounds_and_no_fault_cases_articles_1099_1100",
            "legal_reference": "ГК РФ, статьи 1099 и 1100",
            "basis_url": "https://government.ru/docs/all/95825/",
            "review_required": True,
        },
    ),
    LegalSource(
        id="synthetic-ru-gk1101-moral-harm-form-and-amount-of-compensation-v1",
        title="Синтетическая проверенная модель способа и размера компенсации морального вреда по статье 1101 ГК РФ",
        source_type=SourceType.STATUTE,
        text=(
            "Синтетическое представление: осуществление компенсации морального вреда в денежной "
            "форме, определение её размера судом в зависимости от характера причинённых "
            "физических и нравственных страданий и степени вины причинителя, учёт требований "
            "разумности и справедливости, а также учёт фактических обстоятельств причинения "
            "вреда и индивидуальных особенностей потерпевшего проверяются раздельно "
            "(статья 1101 ГК РФ)."
        ),
        valid_from="1996-03-01",
        metadata={
            "synthetic": True,
            "topic": "moral_harm_form_and_amount_of_compensation_article_1101",
            "legal_reference": "ГК РФ, статья 1101",
            "basis_url": "https://government.ru/docs/all/95825/",
            "review_required": True,
        },
    ),
    LegalSource(
        id="synthetic-case-supply-1-moral-harm-evidence",
        title="Синтетическая проверенная запись фактов о компенсации морального вреда",
        source_type=SourceType.FACT,
        text=(
            "Синтетическая запись: по спорному договору поставки требование о компенсации "
            "морального вреда не заявлялось; физические и нравственные страдания не "
            "устанавливались."
        ),
        valid_from="2026-01-01",
        metadata={
            "synthetic": True,
            "non_authoritative": True,
            "topic": "moral_harm_case_evidence",
            "case_id": "case-supply-1",
        },
    ),
    LegalSource(
        id="synthetic-ru-gk1095-1096-product-defect-harm-and-liable-persons-v1",
        title="Синтетическая проверенная модель оснований возмещения вреда, причинённого вследствие недостатков товара, работы или услуги, и круга ответственных лиц по статьям 1095 и 1096 ГК РФ",
        source_type=SourceType.STATUTE,
        text=(
            "Синтетическое представление: возмещение вреда, причинённого жизни, здоровью или "
            "имуществу вследствие конструктивных, рецептурных и иных недостатков товара, работы "
            "или услуги либо вследствие недостоверной или недостаточной информации о них, "
            "независимо от вины и наличия договорных отношений, требование о приобретении в "
            "потребительских целях, право потерпевшего выбрать продавца или изготовителя, "
            "ответственность исполнителя работы или услуги и ответственность за "
            "непредоставление информации проверяются раздельно (статьи 1095 и 1096 ГК РФ)."
        ),
        valid_from="1996-03-01",
        metadata={
            "synthetic": True,
            "topic": "product_defect_harm_and_liable_persons_articles_1095_1096",
            "legal_reference": "ГК РФ, статьи 1095 и 1096",
            "basis_url": "https://government.ru/docs/all/95825/",
            "review_required": True,
        },
    ),
    LegalSource(
        id="synthetic-ru-gk1097-1098-product-liability-periods-and-exculpation-v1",
        title="Синтетическая проверенная модель сроков возмещения вреда, причинённого недостатками товара, работы или услуги, и оснований освобождения от ответственности по статьям 1097 и 1098 ГК РФ",
        source_type=SourceType.STATUTE,
        text=(
            "Синтетическое представление: возмещение вреда в течение установленного срока "
            "годности или срока службы либо в течение десяти лет со дня производства, "
            "возмещение независимо от времени причинения при неустановлении срока службы в "
            "нарушение закона и при непредупреждении потребителя о необходимых действиях по "
            "истечении срока, а также освобождение от ответственности при непреодолимой силе "
            "или нарушении потребителем правил пользования и хранения проверяются раздельно "
            "(статьи 1097 и 1098 ГК РФ)."
        ),
        valid_from="1996-03-01",
        metadata={
            "synthetic": True,
            "topic": "product_liability_periods_and_exculpation_articles_1097_1098",
            "legal_reference": "ГК РФ, статьи 1097 и 1098",
            "basis_url": "https://government.ru/docs/all/95825/",
            "review_required": True,
        },
    ),
    LegalSource(
        id="synthetic-case-supply-1-product-liability-evidence",
        title="Синтетическая проверенная запись фактов о вреде вследствие недостатков товаров, работ или услуг",
        source_type=SourceType.FACT,
        text=(
            "Синтетическая запись: по спорному договору поставки вред вследствие недостатков "
            "товара, работы или услуги не причинялся; товар не приобретался в потребительских "
            "целях."
        ),
        valid_from="2026-01-01",
        metadata={
            "synthetic": True,
            "non_authoritative": True,
            "topic": "product_liability_case_evidence",
            "case_id": "case-supply-1",
        },
    ),
    LegalSource(
        id="synthetic-ru-gk1084-1087-life-health-harm-scope-and-earnings-v1",
        title="Синтетическая проверенная модель объёма и характера возмещения вреда, причинённого повреждением здоровья, расчёта утраченного заработка и возмещения вреда несовершеннолетнему по статьям 1084–1087 ГК РФ",
        source_type=SourceType.STATUTE,
        text=(
            "Синтетическое представление: применение правил главы 59 к возмещению вреда, "
            "причинённого жизни или здоровью гражданина, состав возмещаемого утраченного "
            "заработка и дополнительно понесённых расходов на лечение, уход и подготовку к "
            "другой профессии, определение размера утраченного заработка по среднему месячному "
            "заработку и степени утраты трудоспособности, а также особенности возмещения вреда "
            "несовершеннолетнему потерпевшему проверяются раздельно (статьи 1084–1087 ГК РФ)."
        ),
        valid_from="1996-03-01",
        metadata={
            "synthetic": True,
            "topic": "life_health_harm_scope_and_earnings_articles_1084_1087",
            "legal_reference": "ГК РФ, статьи 1084–1087",
            "basis_url": "https://government.ru/docs/all/95825/",
            "review_required": True,
        },
    ),
    LegalSource(
        id="synthetic-ru-gk1088-1094-dependants-indexation-and-funeral-expenses-v1",
        title="Синтетическая проверенная модель возмещения вреда лицам, понёсшим ущерб в результате смерти кормильца, изменения размера возмещения, индексации, порядка платежей и расходов на погребение по статьям 1088–1094 ГК РФ",
        source_type=SourceType.STATUTE,
        text=(
            "Синтетическое представление: круг лиц, имеющих право на возмещение вреда в связи "
            "со смертью кормильца, и сроки такого возмещения, определение размера возмещения по "
            "доле заработка умершего, изменение размера возмещения при изменении "
            "трудоспособности и имущественного положения, индексация сумм возмещения, "
            "ежемесячные платежи и капитализация при ликвидации юридического лица, а также "
            "возмещение необходимых расходов на погребение проверяются раздельно "
            "(статьи 1088–1094 ГК РФ)."
        ),
        valid_from="1996-03-01",
        metadata={
            "synthetic": True,
            "topic": "dependants_indexation_and_funeral_expenses_articles_1088_1094",
            "legal_reference": "ГК РФ, статьи 1088–1094",
            "basis_url": "https://government.ru/docs/all/95825/",
            "review_required": True,
        },
    ),
    LegalSource(
        id="synthetic-case-supply-1-tort-life-health-evidence",
        title="Синтетическая проверенная запись фактов о вреде, причинённом жизни или здоровью гражданина",
        source_type=SourceType.FACT,
        text=(
            "Синтетическая запись: по спорному договору поставки вред жизни или здоровью "
            "гражданина не причинялся."
        ),
        valid_from="2026-01-01",
        metadata={
            "synthetic": True,
            "non_authoritative": True,
            "topic": "tort_life_health_case_evidence",
            "case_id": "case-supply-1",
        },
    ),
    LegalSource(
        id="synthetic-ru-gk1064-1070-tort-general-grounds-and-liability-for-others-v1",
        title="Синтетическая проверенная модель общих оснований ответственности за причинение вреда, необходимой обороны и крайней необходимости и ответственности за вред, причинённый другими лицами, по статьям 1064–1070 ГК РФ",
        source_type=SourceType.STATUTE,
        text=(
            "Синтетическое представление: обязанность лица, причинившего вред личности или "
            "имуществу гражданина либо имуществу юридического лица, возместить вред в полном "
            "объёме, презумпция вины причинителя и случаи возмещения вреда при отсутствии вины, "
            "правила о вреде, причинённом в состоянии необходимой обороны и крайней "
            "необходимости, а также ответственность за вред, причинённый работником, "
            "государственными органами и их должностными лицами, проверяются раздельно "
            "(статьи 1064–1070 ГК РФ)."
        ),
        valid_from="1996-03-01",
        metadata={
            "synthetic": True,
            "topic": "tort_general_grounds_and_liability_for_others_articles_1064_1070",
            "legal_reference": "ГК РФ, статьи 1064–1070",
            "basis_url": "https://government.ru/docs/all/95825/",
            "review_required": True,
        },
    ),
    LegalSource(
        id="synthetic-ru-gk1073-1083-tort-high-risk-source-recourse-and-victim-fault-v1",
        title="Синтетическая проверенная модель ответственности за вред, причинённый несовершеннолетними и недееспособными, источником повышенной опасности, солидарной ответственности, регресса, способа возмещения и учёта вины потерпевшего по статьям 1073–1083 ГК РФ",
        source_type=SourceType.STATUTE,
        text=(
            "Синтетическое представление: ответственность за вред, причинённый "
            "несовершеннолетними, недееспособными и лицами, не способными понимать значение "
            "своих действий, ответственность владельца источника повышенной опасности, "
            "солидарная ответственность лиц, совместно причинивших вред, и право регресса, "
            "способ возмещения вреда в натуре или возмещением убытков, а также учёт умысла и "
            "грубой неосторожности потерпевшего и имущественного положения гражданина-"
            "причинителя проверяются раздельно (статьи 1073–1083 ГК РФ)."
        ),
        valid_from="1996-03-01",
        metadata={
            "synthetic": True,
            "topic": "tort_high_risk_source_recourse_and_victim_fault_articles_1073_1083",
            "legal_reference": "ГК РФ, статьи 1073–1083",
            "basis_url": "https://government.ru/docs/all/95825/",
            "review_required": True,
        },
    ),
    LegalSource(
        id="synthetic-case-supply-1-tort-general-evidence",
        title="Синтетическая проверенная запись фактов о возмещении причинённого вреда",
        source_type=SourceType.FACT,
        text=(
            "Синтетическая запись: по спорному договору поставки внедоговорное причинение вреда "
            "личности или имуществу сторон не устанавливалось."
        ),
        valid_from="2026-01-01",
        metadata={
            "synthetic": True,
            "non_authoritative": True,
            "topic": "tort_general_case_evidence",
            "case_id": "case-supply-1",
        },
    ),
    LegalSource(
        id="synthetic-ru-gk1062-judicial-protection-of-claims-from-games-and-betting-v1",
        title="Синтетическая проверенная модель отказа в судебной защите требований из игр и пари и исключений для потерпевших и расчётных сделок по статье 1062 ГК РФ",
        source_type=SourceType.STATUTE,
        text=(
            "Синтетическое представление: правило о том, что требования граждан и юридических "
            "лиц, связанные с организацией игр и пари или с участием в них, не подлежат "
            "судебной защите, исключение для лиц, принявших участие в играх или пари под "
            "влиянием обмана, насилия, угрозы или злонамеренного соглашения представителя с "
            "организатором, а также условия судебной защиты требований из сделок, "
            "предусматривающих обязанность уплатить суммы в зависимости от изменения цен, "
            "курсов валют и иных обстоятельств, проверяются раздельно (статья 1062 ГК РФ)."
        ),
        valid_from="1996-03-01",
        metadata={
            "synthetic": True,
            "topic": "judicial_protection_of_claims_from_games_and_betting_article_1062",
            "legal_reference": "ГК РФ, статья 1062",
            "basis_url": "https://government.ru/docs/all/95825/",
            "review_required": True,
        },
    ),
    LegalSource(
        id="synthetic-ru-gk1063-organization-of-lotteries-and-payment-of-winnings-v1",
        title="Синтетическая проверенная модель организации лотерей, тотализаторов и иных основанных на риске игр, оформления договора с участником и выплаты выигрыша по статье 1063 ГК РФ",
        source_type=SourceType.STATUTE,
        text=(
            "Синтетическое представление: требования к организаторам лотерей, тотализаторов и "
            "других основанных на риске игр, включая публично-правовые образования и лиц с "
            "разрешением (лицензией), оформление договора с участником выдачей лотерейного "
            "билета, квитанции или иного документа, обязательные условия о сроке проведения игр "
            "и порядке определения выигрыша, срок выплаты выигрыша и право участника требовать "
            "выплаты выигрыша и возмещения убытков при её неисполнении проверяются раздельно "
            "(статья 1063 ГК РФ)."
        ),
        valid_from="1996-03-01",
        metadata={
            "synthetic": True,
            "topic": "organization_of_lotteries_and_payment_of_winnings_article_1063",
            "legal_reference": "ГК РФ, статья 1063",
            "basis_url": "https://government.ru/docs/all/95825/",
            "review_required": True,
        },
    ),
    LegalSource(
        id="synthetic-case-supply-1-games-evidence",
        title="Синтетическая проверенная запись фактов о проведении игр и пари",
        source_type=SourceType.FACT,
        text=(
            "Синтетическая запись: по спорному договору поставки игры и пари не проводились; "
            "требования сторон не связаны с организацией игр или с участием в них."
        ),
        valid_from="2026-01-01",
        metadata={
            "synthetic": True,
            "non_authoritative": True,
            "topic": "games_case_evidence",
            "case_id": "case-supply-1",
        },
    ),
    LegalSource(
        id="synthetic-ru-gk1055-1056-public-promise-of-reward-and-revocation-v1",
        title="Синтетическая проверенная модель публичного обещания награды, требований к объявлению, размера и распределения награды и отмены обещания по статьям 1055 и 1056 ГК РФ",
        source_type=SourceType.STATUTE,
        text=(
            "Синтетическое представление: обязанность выплатить обещанную награду тому, кто "
            "совершил указанное в публичном объявлении правомерное действие, требование о "
            "возможности установить, кем награда обещана, право отозвавшегося лица требовать "
            "письменного подтверждения обещания, определение размера награды и её "
            "распределение между несколькими лицами, а также форма и пределы отмены публичного "
            "обещания награды с возмещением расходов отозвавшимся лицам проверяются раздельно "
            "(статьи 1055 и 1056 ГК РФ)."
        ),
        valid_from="1996-03-01",
        metadata={
            "synthetic": True,
            "topic": "public_promise_of_reward_and_revocation_articles_1055_1056",
            "legal_reference": "ГК РФ, статьи 1055 и 1056",
            "basis_url": "https://government.ru/docs/all/95825/",
            "review_required": True,
        },
    ),
    LegalSource(
        id="synthetic-ru-gk1057-1061-public-contest-terms-award-and-works-v1",
        title="Синтетическая проверенная модель организации публичного конкурса, изменения его условий и отмены, решения о выплате награды и возврата работ по статьям 1057–1061 ГК РФ",
        source_type=SourceType.STATUTE,
        text=(
            "Синтетическое представление: обязательные условия объявления о публичном конкурсе, "
            "направленность конкурса на достижение общественно полезных целей, пределы "
            "изменения условий и отмены конкурса с возмещением расходов участникам, порядок и "
            "сроки принятия и объявления решения о выплате награды, использование удостоенных "
            "награды произведений науки, литературы и искусства и обязанность возвратить "
            "участникам работы, не удостоенные награды, проверяются раздельно "
            "(статьи 1057–1061 ГК РФ)."
        ),
        valid_from="1996-03-01",
        metadata={
            "synthetic": True,
            "topic": "public_contest_terms_award_and_works_articles_1057_1061",
            "legal_reference": "ГК РФ, статьи 1057–1061",
            "basis_url": "https://government.ru/docs/all/95825/",
            "review_required": True,
        },
    ),
    LegalSource(
        id="synthetic-case-supply-1-public-promise-evidence",
        title="Синтетическая проверенная запись фактов о публичном обещании награды и публичном конкурсе",
        source_type=SourceType.FACT,
        text=(
            "Синтетическая запись: по спорному договору поставки публичное обещание награды не "
            "объявлялось и публичный конкурс не проводился."
        ),
        valid_from="2026-01-01",
        metadata={
            "synthetic": True,
            "non_authoritative": True,
            "topic": "public_promise_case_evidence",
            "case_id": "case-supply-1",
        },
    ),
    LegalSource(
        id="synthetic-ru-gk1041-1046-partnership-concept-contributions-and-common-affairs-v1",
        title="Синтетическая проверенная модель договора простого товарищества, вкладов товарищей, общего имущества, ведения общих дел, права на информацию и общих расходов по статьям 1041–1046 ГК РФ",
        source_type=SourceType.STATUTE,
        text=(
            "Синтетическое представление: договор простого товарищества как соединение вкладов "
            "и совместная деятельность без образования юридического лица для извлечения прибыли "
            "или достижения иной не противоречащей закону цели, требования к сторонам договора "
            "при предпринимательской цели, состав вкладов товарищей и режим общего имущества, "
            "порядок ведения общих дел и противопоставимость ограничений полномочий третьим "
            "лицам, право каждого товарища знакомиться с документацией и порядок покрытия общих "
            "расходов и убытков проверяются раздельно (статьи 1041–1046 ГК РФ)."
        ),
        valid_from="1996-03-01",
        metadata={
            "synthetic": True,
            "topic": "partnership_concept_contributions_and_common_affairs_articles_1041_1046",
            "legal_reference": "ГК РФ, статьи 1041–1046",
            "basis_url": "https://government.ru/docs/all/95825/",
            "review_required": True,
        },
    ),
    LegalSource(
        id="synthetic-ru-gk1047-1054-partnership-liability-profit-and-termination-v1",
        title="Синтетическая проверенная модель ответственности товарищей, распределения прибыли, выдела доли, прекращения договора и негласного товарищества по статьям 1047–1054 ГК РФ",
        source_type=SourceType.STATUTE,
        text=(
            "Синтетическое представление: долевая и солидарная ответственность товарищей по "
            "общим обязательствам, распределение прибыли пропорционально вкладам и ничтожность "
            "соглашения об устранении товарища от участия в прибыли, выдел доли товарища по "
            "требованию кредитора, основания прекращения договора, отказ от бессрочного "
            "договора и расторжение договора по требованию стороны, а также правила о негласном "
            "товариществе проверяются раздельно (статьи 1047–1054 ГК РФ)."
        ),
        valid_from="1996-03-01",
        metadata={
            "synthetic": True,
            "topic": "partnership_liability_profit_and_termination_articles_1047_1054",
            "legal_reference": "ГК РФ, статьи 1047–1054",
            "basis_url": "https://government.ru/docs/all/95825/",
            "review_required": True,
        },
    ),
    LegalSource(
        id="synthetic-case-supply-1-partnership-evidence",
        title="Синтетическая проверенная запись фактов о простом товариществе",
        source_type=SourceType.FACT,
        text=(
            "Синтетическая запись: по спорному договору поставки вклады в общее дело не "
            "соединялись; договор простого товарищества между сторонами не заключался."
        ),
        valid_from="2026-01-01",
        metadata={
            "synthetic": True,
            "non_authoritative": True,
            "topic": "partnership_case_evidence",
            "case_id": "case-supply-1",
        },
    ),
    LegalSource(
        id="synthetic-ru-gk1027-1029-franchise-concept-form-and-subconcession-v1",
        title="Синтетическая проверенная модель договора коммерческой концессии, его формы, государственной регистрации предоставления права и коммерческой субконцессии по статьям 1027–1029 ГК РФ",
        source_type=SourceType.STATUTE,
        text=(
            "Синтетическое представление: договор коммерческой концессии как предоставление "
            "правообладателем пользователю за вознаграждение права использовать в "
            "предпринимательской деятельности комплекс исключительных прав, включающий право на "
            "товарный знак и знак обслуживания, требования к сторонам договора, письменная форма "
            "договора и государственная регистрация предоставления права использования, а также "
            "условия договора коммерческой субконцессии проверяются раздельно "
            "(статьи 1027–1029 ГК РФ)."
        ),
        valid_from="1996-03-01",
        metadata={
            "synthetic": True,
            "topic": "franchise_concept_form_and_subconcession_articles_1027_1029",
            "legal_reference": "ГК РФ, статьи 1027–1029",
            "basis_url": "https://government.ru/docs/all/95825/",
            "review_required": True,
        },
    ),
    LegalSource(
        id="synthetic-ru-gk1030-1040-franchise-obligations-restrictions-and-termination-v1",
        title="Синтетическая проверенная модель вознаграждения, обязанностей сторон, ограничений их прав, ответственности правообладателя и прекращения договора коммерческой концессии по статьям 1030–1040 ГК РФ",
        source_type=SourceType.STATUTE,
        text=(
            "Синтетическое представление: формы вознаграждения по договору коммерческой "
            "концессии, обязанности правообладателя по передаче документации, инструктированию и "
            "контролю качества, обязанности пользователя по использованию средств "
            "индивидуализации, соблюдению качества и информированию покупателей, допустимые "
            "ограничения прав сторон и ничтожные условия, субсидиарная и солидарная "
            "ответственность правообладателя, а также изменение, прекращение и сохранение "
            "договора проверяются раздельно (статьи 1030–1040 ГК РФ)."
        ),
        valid_from="1996-03-01",
        metadata={
            "synthetic": True,
            "topic": "franchise_obligations_restrictions_and_termination_articles_1030_1040",
            "legal_reference": "ГК РФ, статьи 1030–1040",
            "basis_url": "https://government.ru/docs/all/95825/",
            "review_required": True,
        },
    ),
    LegalSource(
        id="synthetic-case-supply-1-franchise-evidence",
        title="Синтетическая проверенная запись фактов о коммерческой концессии",
        source_type=SourceType.FACT,
        text=(
            "Синтетическая запись: по спорному договору поставки комплекс исключительных прав "
            "не предоставлялся; договор коммерческой концессии между сторонами не заключался."
        ),
        valid_from="2026-01-01",
        metadata={
            "synthetic": True,
            "non_authoritative": True,
            "topic": "franchise_case_evidence",
            "case_id": "case-supply-1",
        },
    ),
    LegalSource(
    ...
    LegalSource(
        id="synthetic-ru-gk4311-entrepreneurial-estoppel-v1",
        title="Синтетическая проверенная модель запрета противоречивого поведения по пункту 2 статьи 431.1 ГК РФ",
        source_type=SourceType.STATUTE,
        text=(
            "Синтетическое представление: сторона, принявшая от контрагента исполнение по "
            "договору, связанному с осуществлением обеими сторонами предпринимательской "
            "деятельности, полностью или частично и не исполнившая своего обязательства либо "
            "предоставившая контрагенту неравноценное встречное исполнение, не вправе "
            "требовать признания договора недействительным по основанию, о котором эта "
            "сторона знала или должна была знать при получении исполнения, за исключением "
            "признания договора недействительным по основаниям статьи 173, пункта 1 статьи "
            "174, статей 178 и 179 ГК РФ либо если предоставление такого исполнения нарушает "
            "охраняемые законом интересы третьих лиц или публичные интересы (пункт 2 статьи "
            "431.1 ГК РФ)."
        ),
        valid_from="2015-06-01",
        metadata={
            "synthetic": True,
            "topic": "entrepreneurial_estoppel_article_431_1",
            "legal_reference": "ГК РФ, пункт 2 статьи 431.1",
            "basis_url": "https://government.ru/docs/all/95825/",
            "review_required": True,
        },
    ),
