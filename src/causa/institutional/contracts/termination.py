...
def build_termination_constraint_set(
    ...
    return TerminationConstraintSet(
        ...
        expressions=[
            ...
            "competing_effective_paths == effective_modification AND effective_termination",
            ...
            "future_obligations_terminated == effective_termination",
            ...
            "judicial_modification_effective == judicial_modification_prerequisites AND court_decision_entered_into_force",
            "judicial_modification_prerequisites == contract_formed AND judicial_request_made AND judicial_request_targets_modification AND pretrial_order_satisfied AND (substantial_breach_ground_satisfied OR other_legal_or_contractual_ground_proven OR changed_circumstances_ground_satisfied AND exceptional_modification_preferred)",
            "judicial_termination_effective == judicial_termination_prerequisites AND court_decision_entered_into_force",
            "judicial_termination_prerequisites == contract_formed AND judicial_request_made AND judicial_request_targets_termination AND pretrial_order_satisfied AND (substantial_breach_ground_satisfied OR other_legal_or_contractual_ground_proven OR changed_circumstances_ground_satisfied)",
            "mutual_modification_effective == contract_formed AND mutual_agreement_reached AND agreement_form_observed AND agreement_effective_date_reached AND agreement_targets_modification",
            "mutual_termination_effective == contract_formed AND mutual_agreement_reached AND agreement_form_observed AND agreement_effective_date_reached AND agreement_targets_termination",
            "pretrial_order_satisfied == pretrial_proposal_delivered AND (pretrial_refusal_received OR pretrial_response_period_expired)",
            "requires_human_termination_assessment == judicial_request_made OR circumstances_substantially_changed OR invalid_unilateral_action OR mutual_agreement_reached AND NOT (mutual_modification_effective OR mutual_termination_effective) OR effective_modification OR effective_termination OR competing_effective_paths OR restitution_issue OR termination_losses_issue",
            ...
            "unilateral_modification_effective == contract_formed AND unilateral_action_declared AND unilateral_right_exists AND unilateral_notice_delivered AND unilateral_requirements_observed AND unilateral_exercise_good_faith AND NOT same_ground_previously_waived AND unilateral_action_targets_modification",
            "unilateral_termination_effective == contract_formed AND unilateral_action_declared AND unilateral_right_exists AND unilateral_notice_delivered AND unilateral_requirements_observed AND unilateral_exercise_good_faith AND NOT same_ground_previously_waived AND unilateral_action_targets_termination",
        ],
    )
