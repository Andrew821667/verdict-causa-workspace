        ...
        escrow_deposit_evidence=ReviewedEscrowDepositEvidence(
            ...
            assertions=tuple(
                ...
                for predicate, value in (
                    ...
                    (EscrowDepositEvidencePredicate.REMUNERATION_LIABILITY_SEVERAL_BY_CONTRACT, False),
                    (EscrowDepositEvidencePredicate.AGENT_SETOFF_PERMITTED_BY_CONTRACT, False),
                    (EscrowDepositEvidencePredicate.AGENT_WITHHELD_OR_SETOFF_DEPOSITED_PROPERTY, False),
                    ...
                    (EscrowDepositEvidencePredicate.TRANSFER_DESPITE_DOUBT_PERMITTED_BY_CONTRACT, False),
                    (EscrowDepositEvidencePredicate.AGENT_TRANSFERRED_PROPERTY_DESPITE_DOUBT, False),
                    (EscrowDepositEvidencePredicate.SUBSTANTIVE_CHECK_AGREED_BY_CONTRACT, False),
                    (EscrowDepositEvidencePredicate.AGENT_TRANSFERRED_WITHOUT_VERIFYING_GROUNDS, False),
                    (EscrowDepositEvidencePredicate.DEPOSITED_PROPERTY_COMMINGLED_WITH_AGENTS_OWN, False),
                    (EscrowDepositEvidencePredicate.USE_OR_DISPOSAL_PERMITTED_BY_CONTRACT_OR_NATURE, False),
                    (EscrowDepositEvidencePredicate.AGENT_USED_OR_DISPOSED_DEPOSITED_PROPERTY, False),
                    ...
                    (EscrowDepositEvidencePredicate.AGENT_PROVED_INHERENT_DEFECT_UNKNOWN_TO_AGENT, False),
                    (EscrowDepositEvidencePredicate.AGENT_PROVED_DEPOSITOR_FAULT, False),
                    (EscrowDepositEvidencePredicate.SECURITIES_EXERCISE_PERMITTED_BY_CONTRACT, False),
                    (EscrowDepositEvidencePredicate.AGENT_DISPOSED_OR_EXERCISED_RIGHTS_ON_SECURITIES, False),
                    (EscrowDepositEvidencePredicate.ESCROW_AGENT_IS_BANK, False),
                    (EscrowDepositEvidencePredicate.SEIZURE_OR_DEBIT_FOR_AGENT_OR_DEPOSITOR_DEBT, False),
                    ...
                    (EscrowDepositEvidencePredicate.CONTRACT_TRANSFERRED_UNDER_ARTICLE_392_3, False),
                )
            ),
