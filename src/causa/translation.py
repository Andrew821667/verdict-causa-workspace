...
class TranslationAssertionCode(str, Enum):
    ...
    SALE_CONTRACT_QUALIFIED = "sale_contract_qualified"
    SALE_TRANSFER_DUTY_PERFORMED = "sale_transfer_duty_performed"
    SALE_THIRD_PARTY_OR_EVICTION_ISSUE = "sale_third_party_or_eviction_issue"
    SALE_QUALITY_REMEDIES_AVAILABLE = "sale_quality_remedies_available"
    SALE_PAYMENT_DEFAULT = "sale_payment_default"
    SALE_TITLE_RETENTION_REMEDY = "sale_title_retention_remedy"
