...
Потому что модели, которая читала бы русский юридический текст, в этом проекте
нет, а внешнюю подключать нельзя. Поиск по словам — то, что можно сделать
честно и проверяемо: правило видно, ошибку видно, воспроизводимость полная.
Всё остальное было бы имитацией понимания.
