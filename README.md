...
Реальные дела прогнаны через **весь конвейер**, а не по одному институту. Из двенадцати дел девять проходят, и вывод института внутри конвейера тот же, что в одиночном прогоне; до слоя общих положений доходят четыре. Три дела конвейер отвергает на сверке входов, и это его измеренная граница: спор о незаключённости или недействительности нельзя наложить на демонстрационное дело, семь контрактов которого утверждают, что договор заключён и действителен. Отказ записывается как результат с причиной, а не роняет прогон. Прогон нашёл переоценку в выпуске `0.98.0`: было написано, что два вывода института возложения ответственности модель «даёт слою общих положений», тогда как среди пятнадцати входов слоя нет ни одного поля этой модели. Запись исправлена. Правила описаны в русской [спецификации прогона через весь конвейер](docs/real-case-pipeline-spec.md).
...
Получены две выгрузки судебной практики. Вторая заменила корпус актами кассационных судов, разрешающими спор окончательно, и перенесла годные дела первой: в базе 55 дел, все с окончательным исходом, тем без единого дела не осталось. Дел, пригодных для полной сверки, стало 50 вместо 5. Переведено в предикаты 12, сошлись все 12; остальные 42 стоят в поимённой очереди, а одно дело признано непереводимым — спор разрешён по Закону об ОСАГО, вне моделируемых норм. Три графы разведены намеренно: общая запись «не переведено» превратила бы проверку полноты в отметку о прочтении. Заодно снято списочное ограничение на институты — раннер собирается по имени и есть у каждого из 85, а не у выбранных вручную четырёх. Правила описаны в русской [спецификации прогона на реальных делах](docs/real-case-scenarios-spec.md).
