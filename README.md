...
Релиз `contracts-ru-v0@0.64.0` добавляет формальную модель банковского вклада по статьям 834–844 ГК РФ (глава 44): квалификацию договора, право привлекать денежные средства во вклады, обязательную письменную форму под страхом ничтожности, выдачу вклада по первому требованию вкладчика, размер процентов при досрочном возврате, выплату процентов на сумму вклада, запрет одностороннего уменьшения ставки по срочному вкладу гражданина, обеспечение возврата вклада, вклады третьих лиц и в пользу третьих лиц, а также правила о сберегательной книжке и сберегательном сертификате. Этот выпуск открывает главу 44 ГК РФ. Правила описаны в русской [спецификации банковского вклада](docs/contract-bank-deposit-spec.md).

Релиз `contracts-ru-v0@0.63.0` добавляет формальную модель финансирования под уступку денежного требования (факторинга) по статьям 824–833 ГК РФ (глава 43): квалификацию договора, определённость уступаемого требования, право финансового агента осуществлять такую деятельность, недействительность договорного запрета уступки против агента, ответственность клиента за действительность требования, допустимость последующей уступки, уведомление должника об уступке, зачёт встречных требований должника, расчёты финансового агента с клиентом и надлежащего адресата требования должника о возврате сумм. Этот выпуск открывает главу 43 ГК РФ. Правила описаны в русской [спецификации финансирования под уступку денежного требования](docs/contract-factoring-spec.md).

Релиз `contracts-ru-v0@0.62.0` добавляет формальную модель товарного и коммерческого кредита по статьям 822 и 823 ГК РФ (глава 42, § 3): квалификацию товарного кредита, предоставление вещей, определённых родовыми признаками, условия о количестве, ассортименте, комплектности, качестве, таре и упаковке, применение правил о займе, квалификацию коммерческого кредита в виде аванса, предварительной оплаты, отсрочки и рассрочки, согласование его условий, проценты, пределы применения правил главы и установленный законом запрет. Этот выпуск завершает главу 42 ГК РФ «Заём и кредит». Правила описаны в русской [спецификации товарного и коммерческого кредита](docs/contract-commercial-credit-spec.md).

Релиз `contracts-ru-v0@0.61.0` добавляет формальную модель кредита по статьям 819–821.1 ГК РФ (глава 42, § 2): квалификацию кредитного договора, статус кредитора как банка или иной кредитной организации, условия о процентах и иных платежах, применение правил о потребительском кредите, обязательную письменную форму под страхом ничтожности, отказ кредитора при обстоятельствах невозврата, уведомление заёмщика об отказе от получения, последствия нецелевого использования и требование досрочного возврата, включая ограничение для заёмщика-гражданина. Правила описаны в русской [спецификации кредита](docs/contract-credit-spec.md).

Релиз `contracts-ru-v0@0.60.0` добавляет формальную модель займа по статьям 807–818 ГК РФ (глава 42, § 1): квалификацию займа, письменную форму договора, правила о процентах за пользование займом и о беспроцентном займе, уменьшение судом чрезмерно обременительных ростовщических процентов, обязанность возвратить сумму займа в срок, начисление процентов при просрочке, оспаривание займа по безденежности, последствия утраты обеспечения, контроль за использованием целевого займа и новацию долга в заёмное обязательство. Правила описаны в русской [спецификации займа](docs/contract-loan-spec.md).

Релиз `contracts-ru-v0@0.59.0` добавляет формальную модель транспортной экспедиции по статьям 801–806 ГК РФ (глава 41): квалификацию экспедиции, письменную форму договора и выдачу доверенности, выполнение и организацию экспедиционных услуг, ответственность экспедитора по правилам ответственности перевозчика, обязанность клиента предоставить документы и информацию о грузе, обязанность экспедитора сообщить о неполноте сведений, привлечение третьих лиц, предупреждение об одностороннем отказе в разумный срок, возмещение убытков от расторжения и уплату штрафа. Правила описаны в русской [спецификации транспортной экспедиции](docs/contract-forwarding-spec.md).

Релиз `contracts-ru-v0@0.58.0` добавляет формальную модель общих положений о перевозке по статьям 784–800 ГК РФ (глава 40): квалификацию перевозки, подтверждение договора транспортной накладной, билетом и багажной квитанцией, публичный характер перевозки транспортом общего пользования, правила о провозной плате и удержании груза, подачу транспортных средств и их использование, сроки доставки, ответственность за задержку отправления пассажира, ответственность за утрату и повреждение груза и недействительность соглашений об ограничении ответственности перевозчика. Правила описаны в русской [спецификации перевозки](docs/contract-carriage-spec.md).

Релиз `contracts-ru-v0@0.57.0` добавляет формальную модель возмездного оказания услуг по статьям 779–783.1 ГК РФ (глава 39): квалификацию договора, исключение услуг, оказываемых по договорам отдельных глав Кодекса, обязанность оказать услуги лично, сроки и порядок оплаты, полную оплату при невозможности исполнения по вине заказчика, возмещение фактически понесённых расходов при невозможности без вины сторон, односторонний отказ заказчика с оплатой расходов, односторонний отказ исполнителя с полным возмещением убытков и правила приостановления оказания услуг связи. Правила описаны в русской [спецификации возмездного оказания услуг](docs/contract-paid-services-spec.md).

Релиз `contracts-ru-v0@0.56.0` добавляет формальную модель договоров на выполнение научно-исследовательских, опытно-конструкторских и технологических работ по статьям 769–778 ГК РФ (глава 38): квалификацию договора, обязанность провести научные исследования лично, конфиденциальность сведений и согласование публикаций, пределы и условия использования результатов, гарантию ненарушения исключительных прав других лиц, незамедлительное сообщение о невозможности получить результат, обязанности заказчика, последствия невозможности достижения результата и ответственность исполнителя. Правила описаны в русской [спецификации научно-исследовательских работ](docs/contract-research-work-spec.md).

Релиз `contracts-ru-v0@0.55.0` добавляет формальную модель подрядных работ для государственных и муниципальных нужд по статьям 763–768 ГК РФ (глава 37, § 5): квалификацию работ для государственных или муниципальных нужд, требование государственного или муниципального контракта, статус заказчика как получателя бюджетных средств, порядок заключения контракта, обязательные условия об объёме и стоимости работ, сроках начала и окончания, размере и порядке финансирования и оплаты и способах обеспечения исполнения обязательств, согласование новых условий при уменьшении бюджетных средств и возмещение убытков подрядчика. Этот выпуск завершает главу 37 ГК РФ «Подряд». Правила описаны в русской [спецификации подрядных работ для государственных нужд](docs/contract-state-work-spec.md).

Релиз `contracts-ru-v0@0.54.0` добавляет формальную модель подряда на выполнение проектных и изыскательских работ по статьям 758–762 ГК РФ (глава 37, § 4): квалификацию договора, передачу задания на проектирование и иных исходных данных, запрет отступать от требований задания без согласия заказчика, согласование готовой документации с заказчиком и компетентными органами, запрет передавать документацию третьим лицам, гарантию отсутствия у третьих лиц права воспрепятствовать работам, ответственность подрядчика за ненадлежащее составление документации, выявление недостатков в ходе строительства или эксплуатации, оплату и содействие заказчика и возмещение дополнительных расходов при изменении исходных данных. Правила описаны в русской [спецификации проектных и изыскательских работ](docs/contract-design-work-spec.md).

Релиз `contracts-ru-v0@0.53.0` добавляет формальную модель строительного подряда по статьям 740–757 ГК РФ (глава 37, § 3): квалификацию строительного подряда, страхование риска случайной гибели объекта, согласование технической документации и сметы, сообщение заказчику о не учтённых в документации работах, предоставление земельного участка и услуг, контроль заказчика за ходом и качеством работ, расчёты при консервации строительства, односторонний акт приёмки при необоснованном отказе от его подписания, ответственность за отступления от документации и обязательных строительных норм и предельный пятилетний срок обнаружения недостатков. Правила описаны в русской [спецификации строительного подряда](docs/contract-construction-contract-spec.md).

Релиз `contracts-ru-v0@0.52.0` добавляет формальную модель бытового подряда по статьям 730–739 ГК РФ (глава 37, § 2): квалификацию бытового подряда, запрет навязывать заказчику дополнительную работу, право заказчика в любое время до сдачи работы прекратить договор, обязанность сообщить необходимую и достоверную информацию о работе, последствия использования недоброкачественного материала подрядчика, порядок оплаты после окончательной сдачи работы, обязанность сообщить требования к использованию результата, требования при существенных недостатках, десятилетний срок их обнаружения и двухмесячное предупреждение перед продажей невостребованного результата. Правила описаны в русской [спецификации бытового подряда](docs/contract-consumer-work-spec.md).

Релиз `contracts-ru-v0@0.51.0` добавляет формальную модель общих положений о подряде по статьям 702–729 ГК РФ (глава 37, § 1): квалификацию подряда, обязанность выполнить работу лично, согласование начального и конечного сроков, предупреждение о существенном превышении сметы, непригодность материала заказчика, предупреждение об обстоятельствах, угрожающих годности работы, ответственность за недостатки результата, срок их обнаружения, обязанность осмотреть и принять результат и оплату выполненной части при одностороннем отказе заказчика. Правила описаны в русской [спецификации подряда](docs/contract-work-contract-spec.md).
...
Команда формирует отчёты о необходимости replay для прежних релизов и пересобирает их относительно `0.64.0`. Отчёты сохраняются как `examples/migrations/contracts-ru-v0-<source>-to-0.64.0-migration-report.json` для `0.1.0`, `0.3.0` и каждого релиза с `0.4.0` по `0.63.0`. Прежние отчёты `*-to-0.17.0` … `*-to-0.63.0` сохраняются как исторические артефакты.
